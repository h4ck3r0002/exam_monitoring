...
# Khởi tạo bộ phát hiện HOG cho người
...
def process_video(monitor_id):
    ...
    camera = cv2.VideoCapture(video_path)
    is_cheat = False
    no_person_frames = 0  # Đếm số khung hình không phát hiện người
    max_no_person_frames = 10  # Ngưỡng khung hình liên tiếp không có người trước khi cảnh báo
    ...
    while camera.isOpened():
        ...
        people, _ = hog.detectMultiScale(frame, winStride=(8, 8), padding=(8, 8), scale=1.05)
        ...
        if len(people) == 0:
            ...
            # Reset no_person_frames vì đã phát hiện thấy người
            no_person_frames = 0
